...
We developed a system where we didn't touch a bathroom/remodel until my Client paid to inspect & estimate it.

We also set the protocol that he can readjust the project price -- if there’s something that didn’t come up with the first inspection (after demo is completed).
